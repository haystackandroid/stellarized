...
Small adjustments were made to base colour brightness in order to snap values to 1/24 intervals. Accent colours were HSV-adjusted (also using discrete intervals) by eye to suit the new backgrounds.

...
hexgry1_lt = tohex( gold(0.14) , gold(4.50) , hue_bas0 )
hexgry2_lt = tohex( gold(1.19) , gold(4.50) , hue_bas1 )
hexgry3_lt = tohex( gold(1.61) , gold(4.50) , hue_bas1 )
hexgryc_lt = tohex( gold(2.01) , gold(4.75) , hue_bas1 )
hexyllw_lt = tohex( gold(0.25) , gold(0.00) , hue_yllw )

hexgry0_dk = tohex( gold(3.50) , gold(5.00) , hue_bas1 )
hexgry1_dk = tohex( gold(3.07) , gold(4.75) , hue_bas1 )
hexgry2_dk = tohex( gold(1.30) , gold(4.50) , hue_bas0 )
hexgry3_dk = tohex( gold(0.91) , gold(4.50) , hue_bas0 )

...
hexgry0_lt = tohex(11.5/12.0*100.0,base_sat,75.0)
hexgry1_lt = tohex(10.5/12.0*100.0,base_sat,75.0)
hexgry2_lt = tohex(06.5/12.0*100.0,base_sat,285.0)
hexgry3_lt = tohex(05.0/12.0*100.0,base_sat,285.0)
...
hexgry0_dk = tohex(02.0/12.0*100.0,base_sat,285.0)
hexgry1_dk = tohex(03.0/12.0*100.0,base_sat,285.0)
hexgry2_dk = tohex(06.5/12.0*100.0,base_sat,75.0)
hexgry3_dk = tohex(08.0/12.0*100.0,base_sat,75.0)

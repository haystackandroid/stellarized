...
hexgry0_lt = tohex(11.50/12.0*100.0,base_sat,75.0)
hexgry1_lt = tohex(10.50/12.0*100.0,base_sat,75.0)
hexgry2_lt = tohex(06.75/12.0*100.0,base_sat,285.0)
hexgry3_lt = tohex(05.25/12.0*100.0,base_sat,285.0)
...
hexgry0_dk = tohex(02.00/12.0*100.0,base_sat,285.0)
hexgry1_dk = tohex(03.00/12.0*100.0,base_sat,285.0)
hexgry2_dk = tohex(06.25/12.0*100.0,base_sat,75.0)
hexgry3_dk = tohex(08.00/12.0*100.0,base_sat,75.0)

...
if &background ==# 'dark'
  ...
  hi DiffDelete ctermfg=174 ctermbg=236 guifg=#c6837c guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffRemoved ctermfg=174 ctermbg=236 guifg=#c6837c guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Error ctermfg=174 ctermbg=236 guifg=#c6837c guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ErrorMsg ctermfg=174 ctermbg=236 guifg=#c6837c guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi Search ctermfg=137 ctermbg=236 guifg=#a89266 guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi DiffAdd ctermfg=108 ctermbg=236 guifg=#7f9d77 guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffAdded ctermfg=108 ctermbg=236 guifg=#7f9d77 guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLineSel ctermfg=108 ctermbg=236 guifg=#7f9d77 guibg=#282d3e guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi DiffDelete ctermfg=131 ctermbg=255 guifg=#c04c48 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffRemoved ctermfg=131 ctermbg=255 guifg=#c04c48 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Error ctermfg=131 ctermbg=255 guifg=#c04c48 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ErrorMsg ctermfg=131 ctermbg=255 guifg=#c04c48 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi DiffAdd ctermfg=28 ctermbg=255 guifg=#3f8234 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffAdded ctermfg=28 ctermbg=255 guifg=#3f8234 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi TabLineSel ctermfg=28 ctermbg=255 guifg=#3f8234 guibg=#fff3e2 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
" Color:      red_ #c04c48 131
" Color:      gold #8e6e10 094
" Color:      gren #3f8234 028
" Color:      cyan #008888 030
...
" Color:      srch #a89266 137
" Color:      grys #282d3e 236
" Color:      sprd #ff005f 197
" Color:      spbl #0087ff 033
" Color:      spcy #0087af 031
" Color:      spmg #d700d7 164
" Color:      red_ #c6837c 174
" Color:      gold #a89266 137
" Color:      gren #7f9d77 108
" Color:      cyan #65a09e 073
" Color:      blue #7899c4 110
